                    ...
                    {!launch && (
                        <S.TitleWrapper isMobile={isMobile}>
                            ...
                            <S.RocketInfo className="rocket-info">
                                <p>
                                    <span className="rocket">로켓</span>을
                                    눌러보세요!
                                </p>
                            </S.RocketInfo>
                        </S.TitleWrapper>
                                ...
                                {modalPage == 1 && (
                                    <S.InfoModal>
                                        ...
                                        <p>
                                            ...
                                            <br />
                                            새로 들어오시는 학회원들은{" "}
                                            <b>10만원</b>의 학회비를 납부하고,
                                            해당 금액은 학회 운영을 위해서만
                                            사용될 예정입니다.
                                            <br />
                                            학회원들은 모든 회계 정산 내용을
                                            활동 종료 이후 학회 노션 페이지에서
                                            확인하실 수 있습니다. <br />
                                            <br />
                                            <span>6. 오리엔테이션 필참</span>
                                            <br />
                                            최종 합격 이후 <b>3월 1일(토)</b>에
                                            진행되는 OT는 필수 참여입니다.
                                            원활한 학회 운영을 위해, OT를
                                            고려하여 개인 일정을 조정해주시면
                                            감사하겠습니다

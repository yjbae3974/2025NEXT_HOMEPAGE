                ...
                <S.TextElementWrapper data-aos="fade">
                    <div>
                        ...
                        <p>
                            ...
                            라는 <span style={{ color: 'orange', fontWeight: 'bold' }}>로켓</span>에 올라타세요.
                        </p>
                        <br />
                        <p>ACCELERATE YOUR POTENTIAL</p>
                    </div>
                    <p>
                        <b style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'flex-end' }}>
                            NEXT 13기 임원진 드림
                        </b>
                        <span
                            style={{
                        ...
                        >
                            ...
                            &nbsp;&nbsp;김정현 |
                            <b style={{ color: '#000', fontWeight: '500', paddingLeft: '3px' }}>부대표</b>
                            &nbsp;&nbsp;송하영, 김강민 |
                            <b style={{ color: '#000', fontWeight: '500', paddingLeft: '3px' }}>창업팀장</b>
                            &nbsp;&nbsp;신현성 |
                            <b style={{ color: '#000', fontWeight: '500', paddingLeft: '3px' }}>개발팀장</b>
                            &nbsp;&nbsp;배연준
                        </span>
                    </p>
